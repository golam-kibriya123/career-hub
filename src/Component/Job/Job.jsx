...
const Job = ({ job }) => {
    const { vacancy_position, logo, company_name, salary, location } = job;
    return (
        <div className="border w-full  md:w-[570px]  mx-auto rounded-md p-10 text-start">
            <div className="h-12">            <img src={logo} alt="" className="w-28" />
</div>
            ...
            <button className=" bg-gradient-to-l to-bgL1 from-bgD1 md:py-4 md:px-5 py-3 px-4 text-sm  rounded-lg  text-textL1 md:text-xl font-extrabold mt-6 "
            >View Details</button>
