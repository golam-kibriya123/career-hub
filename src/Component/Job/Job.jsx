...
const Job = ({ job }) => {
    const { vacancy_position, logo, company_name, salary, location, id, types } = job;

    return (
        <div className="border w-full  md:w-[570px]  mx-auto rounded-md md:p-10 p-3 text-start">
            <div className="h-12">
            ...
            ">{types.map(type => <button className="border border-bgD1 py-2 px-4 mr-2 rounded-md ">{type}</button>
            )}
            </div>
